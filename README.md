...
**TKTK: Describe deep-tunnel here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/deep_tunnel/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|deep-tunnel|tweet|`location`||
|deep-tunnel|facebook|`location`||
|deep-tunnel|email|`location`||
|deep-tunnel|new-comment||
|deep-tunnel|open-share-discuss||
|deep-tunnel|close-share-discuss||
|deep-tunnel|summary-copied||
|deep-tunnel|featured-tweet-action|`action`|
|deep-tunnel|featured-facebook-action|`action`|
